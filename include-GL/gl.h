 ...
 * added include-GL 1.2 3-D texture enums and functions
 *
...
#define	GL_TEXTURE_BINDING_3D            0x806A
	...
	/* Internal texture formats (include-GL 1.1) */
...
/*  C type              include-GL type         storage                            */
/*-------------------------------------------------------------------------*/
typedef void            GLvoid;
